...
class AttendanceBusinessTripController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'transportation_mode' => [
                Rule::requiredIf($request->input('transportation_arrangement') === 'booked_by_ga'),
                'nullable',
                Rule::in(['flight', 'bus', 'train', 'car']),
            ],
            'departure_date' => [
                Rule::requiredIf($request->input('transportation_arrangement') === 'booked_by_ga'),
                'nullable',
            ...
            'check_in_date' => [
                Rule::requiredIf($request->input('accommodation_arrangement') === 'booked_by_ga'),
                'nullable',
                'date',
            ],
            'check_out_date' => [
