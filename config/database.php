    ...
    */
    ...
    'connections' => [
        ...
        'legacy_mysql' => [
            ...
            'database' => env('LEGACY_DB_DATABASE', 'rnbmanag_andalanbersamacom'),
            'username' => env('LEGACY_DB_USERNAME', env('DB_USERNAME', 'rnbmanag_admin')),
            'password' => env('LEGACY_DB_PASSWORD', env('DB_PASSWORD', 'Rnbmanag123456')),
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => env('LEGACY_DB_STRICT', true),
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
