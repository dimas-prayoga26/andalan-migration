...
@section('content')
    ...
    <div id="project-list-pane" class="row g-4">
        <div class="col-xl-6">
            <div class="card h-100">
                <div class="card-header border-0 d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <h4 class="card-title m-0">Pending <span class="text-danger">(High Priority)</span></h4>
        ...
        <div class="col-xl-6">
            <div class="card h-100">
                <div class="card-header border-0 d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <h4 class="card-title m-0">Status : <span class="text-success">Approved</span></h4>
                    <div class="d-flex gap-2">
            ...
            <div class="col-xxl-3 col-xl-4 col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-footer d-flex justify-content-between align-items-center">
                        <span class="fw-semibold text-success">SPV : Approved</span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            createLeaveTable(
                ...
                '{{ route('admin-attendance.leave.pending-datatable') }}',
                '#adminLeavePendingMonth',
                '#adminLeavePendingYear'
            );
            createLeaveTable(
                '#adminLeaveApprovedTable',
                '{{ route('admin-attendance.leave.approved-datatable') }}',
