        ...
        <div class="card">
            <div class="card-header border-0 align-items-center gap-2 flex-wrap">
                ...
                <div class="clearfix d-flex align-items-center">
                    <form id="recapDetailPeriodFilter" method="GET" action="{{ route('admin-attendance.recap.detail-employees', ['employee' => $recapDetailEmployee['id'] ?? '']) }}" class="clearfix d-flex align-items-center">
		...
		var dzChartlist = function(){
			...
			jQuery(document).ready(function(){
				...
				var detailTable = jQuery('#recapDetailAttendanceTable').DataTable({
					ajax: {
						url: @json(route('admin-attendance.recap.detail-employees.datatable', ['employee' => $recapDetailEmployee['id'] ?? ''])),
