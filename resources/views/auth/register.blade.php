						...
						<form action="index.html">
							...
							<div class="form-group mb-3">
								...
								<div class="position-relative">
									<input type="password" autocomplete="current-password" class="form-control form-control-lg dz-password" placeholder="Enter your password" value="123456">
							...
							<div class="text-center mt-4">
								<button type="submit" class="btn btn-primary btn-lg w-100 ">Sign me up</button>
							</div>
						</form>
						<div class="mt-3">
							<p>Already have an account? <a class="text-primary" href="pages/login.html">Sign in</a></p>
						</div>
					</div>
                </div>
            </div>
