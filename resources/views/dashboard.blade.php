                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="progress position-absolute bottom-0 start-0 w-100" style="height:5px;">
                                        <div class="progress-bar bg-success position-absolute rounded bootom-0" style="width: 42%; height:5px;" aria-label="Progess-success" role="progressbar">
                    ...
                    <div class="dashboard-activity-item">
                        <div class="card overflow-hidden avtivity-card">
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="progress position-absolute bottom-0 start-0 w-100" style="height:5px;">
                                        <div class="progress-bar rounded bg-secondary" style="width: 82%; height:5px;" aria-label="Progess-secondary" role="progressbar">
                                            <span class="sr-only">42% Complete</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="dashboard-activity-item">
                        <div class="card overflow-hidden avtivity-card">
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="progress position-absolute bottom-0 start-0 w-100" style="height:5px;">
                                        <div class="progress-bar rounded bg-danger" style="width: 90%; height:5px;" aria-label="Progess-danger"  role="progressbar">
                                            <span class="sr-only">42% Complete</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="dashboard-activity-item">
                        <div class="card overflow-hidden avtivity-card">
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="progress position-absolute bottom-0 start-0 w-100" style="height:5px;">
                                        <div class="progress-bar rounded bg-warning" style="width: 42%; height:5px;" role="progressbar">
                                            <span class="sr-only">42% Complete</span>
                                        </div>
                                    </div>
                                </div>
