...
<div id="recapAttendanceCaptureArea" class="card recap-attendance-card" data-capture-title="{{ $recapAttendanceDayLabel }}" data-capture-subtitle="">
	<div class="card-header border-0 align-items-center justify-content-between flex-wrap gap-2">
		<div class="d-flex align-items-center flex-wrap gap-2">
			<form id="recapDailyAttendanceFilter" method="GET" action="{{ route('pic-attendance.attendance') }}" class="d-flex align-items-center">
...
<div class="card recap-monthly-card">
	<div class="card-header border-0 align-items-center justify-content-between flex-wrap recap-monthly-header">
		...
		<div class="d-flex align-items-center recap-monthly-filter-wrap">
			<form id="recapMonthlyFilter" method="GET" action="{{ route('pic-attendance.attendance') }}" class="clearfix d-flex align-items-center recap-monthly-filter">
    ...
    (function () {
        ...
        if (window.jQuery && jQuery.fn.DataTable) {
            jQuery(function ($) {
                ...
                var employeeDetailBaseUrl = @json(url('/pic-attendance/attendance'));
                var monthlyTable = $('#recapMonthlyTable').DataTable({
                    ajax: {
                        url: @json(route('pic-attendance.attendance.monthly-datatable')),
