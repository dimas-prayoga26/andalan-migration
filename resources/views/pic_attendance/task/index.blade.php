...
@section('content')
    ...
    <div class="row">
        <div class="d-flex flex-wrap gap-3 justify-content-between align-items-center d-block mb-4">
                ...
                <div class="d-flex gap-3">
                    <a class="btn btn-lg btn-primary fw-bold rounded" data-bs-toggle="modal" data-bs-target="#filterTaskAndStaff">
                        ...
                        </svg>Amelia Rose | September 2026
                    </a>
                </div>
            </div>
    ...
    <!-- Start - Modal Filter Task -->
    <div class="modal fade" id="filterTaskAndStaff">
                    ...
                    <form class="comment-form">
                        <div class="row"> 
                            <div class="col-12 col-lg-12">
                                <div class="mb-3">
                                    <label class="form-label">Staff <span class="required text-danger">*</span></label>
                                    <select class="form-control default-select">
                                        <option value="1">John Doe</option>
                                        <option value="2">Jane Smith</option>
                                        <option value="3">Bob Johnson</option>
                                        <option value="4">Alice Williams</option>
                                        <option value="5" selected>Charlie Brown</option>
                                        <option value="6">Diana Miller
                                    </select>
                                </div>
                            </div>
