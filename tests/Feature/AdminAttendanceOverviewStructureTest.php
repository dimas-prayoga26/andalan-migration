...
class AdminAttendanceOverviewStructureTest extends TestCase
{
    public function test_overview_and_recap_use_separate_controllers(): void
    {
        ...
        $this->assertStringContainsString('Staff submitted <span class="text-muted">(Total Duration)</span>', $overtimeDetailView);
        $this->assertStringContainsString('$overtimeDetail[\'staff_submitted_time_range\']', $overtimeDetailView);
        $this->assertStringContainsString('$overtimeDetail[\'staff_submitted_duration\']', $overtimeDetailView);
        ...
        $this->assertStringContainsString('<span class="text-gray fw-semibold">-</span>', $overtimeDetailView);
        ...
        $this->assertStringNotContainsString('<span class="text-gray">, {{ $overtimeDetail[\'actual_time_range\'] ?? \'-\' }}</span>', $overtimeDetailView);
        $this->assertStringNotContainsString('<span class="text-gray">, {{ $overtimeDetail[\'actual_duration\'] ?? \'-\' }}</span>', $overtimeDetailView);
