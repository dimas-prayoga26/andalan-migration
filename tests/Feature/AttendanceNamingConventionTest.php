...
class AttendanceNamingConventionTest extends TestCase
{
    public function test_attendance_module_uses_english_route_and_view_names(): void
    {
        ...
        $this->assertStringContainsString('100 - (($monthlyAlphaDaysCount / $workingDaysInCurrentMonth) * 100)', $attendanceProfileComposer);
        $this->assertStringContainsString('100 - (($monthlyLateCount / $workingDaysInCurrentMonth) * 100)', $attendanceProfileComposer);
        $this->assertStringContainsString('min(($monthlyLateCount / $workingDaysInCurrentMonth) * 100, 100.0)', $attendanceProfileComposer);
        ...
        $this->assertStringNotContainsString('($monthlyOnTimeCount / $workingDaysInCurrentMonth) * 100', $attendanceProfileComposer);
        ...
        $this->assertStringNotContainsString('$profileData[\'profileAttendanceDaysCount\'] / $workingDaysInCurrentMonth', $attendanceProfileComposer);
        ...
        $this->assertStringContainsString('$attendanceRateLabel = rtrim(rtrim(number_format($attendanceRatePercent, 2, \'.\', \'\'), \'0\'), \'.\');', $attendanceCardAnalyticsView);
        $this->assertStringContainsString('$onTimeRatePercent = (float) ($profileOnTimeRatePercent ?? 0);', $attendanceCardAnalyticsView);
        $this->assertStringContainsString('$onTimeRateLabel = rtrim(rtrim(number_format($onTimeRatePercent, 2, \'.\', \'\'), \'0\'), \'.\');', $attendanceCardAnalyticsView);
        $this->assertStringContainsString('$latenessRatePercent = (float) ($profileLatenessRatePercent ?? 0);', $attendanceCardAnalyticsView);
        $this->assertStringContainsString('$latenessRateLabel = rtrim(rtrim(number_format($latenessRatePercent, 2, \'.\', \'\'), \'0\'), \'.\');', $attendanceCardAnalyticsView);
