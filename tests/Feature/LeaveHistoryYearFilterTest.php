...
class LeaveHistoryYearFilterTest extends TestCase
{
    ...
    public function test_leave_summary_is_split_into_eligibility_and_tracker_data(): void
    {
        ...
        foreach ([
            ...
            'id="Eligibility"',
            'id="Tracker"',
            'leave-summary-icon--eligibility',
            'leave-summary-icon--tracker',
            ...
            'class="btn light btn-success mt-3 mb-0 btn-lg w-100" id="leaveRequestSubmitButton"',
        ...
        foreach ([
            ...
            '$this->jointHolidaySummaryService->forYear($currentYear, $now)',
        ...
        foreach ([
            ...
            'btn light btn-success m-3 mb-2 btn-lg w-100',
            'M10.8586 5.22599',
            'Demam dan Flu',
